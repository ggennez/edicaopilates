...
const FAQItem: React.FC<{ q: string; a: string }> = ({ q, a }) => {
  ...
  return (
    <div className="border border-white/10 surface-frosted overflow-hidden">
      <motion.button 
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-6xl bg-brand-primary border border-white/10 overflow-hidden surface-frosted max-h-[94vh] overflow-y-auto"
          >
            <button 
              onClick={onClose}
              className="absolute top-4 right-4 z-10 p-2 bg-brand-accent text-brand-primary hover:bg-brand-lavender transition-colors"
            >
              <X size={24} />
            </button>

            <div className="grid grid-cols-1 md:grid-cols-[minmax(320px,40%)_1fr]">
              ...
              <div className="p-6 md:p-10 flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-5xl font-display font-bold mb-5 text-brand-lavender">{speaker.name}</h3>
                
                <div className="space-y-6">
                  <div>
                    <p className="text-brand-accent text-[10px] font-bold tracking-widest mb-3 uppercase">Especialidades</p>
                    <div className="flex flex-wrap gap-2.5">
                      {speaker.tags.map((tag) => (
                        <div
                          key={tag}
                          className="px-3 py-1.5 bg-brand-accent/10 border border-brand-accent/20 text-[11px] font-bold text-brand-accent uppercase tracking-wider"
                        >
                          {tag}
                        </div>
                      ))}
                  ...
                  <div>
                    ...
                    <p className="text-brand-lavender/70 leading-relaxed text-base md:text-lg whitespace-pre-line">
                      {speaker.bio}
                    </p>
                  </div>
  ...
  return (
    <div className="min-h-screen bg-brand-primary overflow-x-hidden text-brand-lavender selection:bg-brand-accent selection:text-brand-primary">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute inset-0 u-bg-dot-grid opacity-20" />
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-brand-primary via-brand-primary to-brand-accent/5 u-animate-bg-gradient" />
          ...
          <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="font-display font-bold text-2xl md:text-3xl tracking-tighter group cursor-pointer">
                <img src={assetUrl('branding/logo-completo.svg')} alt="Edição Pilates" className="h-8 md:h-10" />
              </div>
              <Countdown compact />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-8 border border-white/10 surface-frosted hover:border-brand-accent/30 transition-all duration-500 group">
      ...
      <section className="py-32 md:py-56 px-6 bg-brand-primary relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          />
          <div className="absolute inset-0 u-bg-dot-grid opacity-10" />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24">
            {PROMISES.map((obj, i) => {
              const Icon = PROMISE_ICON_MAP[obj.icon];
              return (
              <motion.div 
                key={obj.id}
                initial={{ opacity: 0, scale: 0.9 }}
              ...
              >
                ...
                <p className="text-brand-lavender/60 leading-relaxed text-lg">{obj.description}</p>
      ...
      <section className="py-32 md:py-56 px-6 bg-brand-primary relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { image: "images/gallery/edicao-pilates-foto9.jpeg", title: "Conexão", desc: "A integração total entre mente e corpo." },
              { image: "images/gallery/edicao-pilates-foto16.jpeg", title: "Equilíbrio", desc: "A harmonia entre força e flexibilidade." },
              { image: "images/gallery/edicao-pilates-foto1.jpeg", title: "Evolução", desc: "O aprimoramento constante da técnica." }
            ].map((pillar, i) => (
              <motion.div 
                key={i}
            ...
            {SPEAKERS.map((speaker, i) => (
              <React.Fragment key={i}>
                ...
                <motion.div 
                  ...
                  className="group relative bg-brand-primary border border-white/10 overflow-hidden surface-frosted"
                >
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 rounded-full overflow-hidden border border-brand-accent/30">
                        <img src={assetUrl(speaker.image)} alt={speaker.name} className="w-full h-full object-cover grayscale" referrerPolicy="no-referrer" />
                      </div>
                      <div>
            ...
            {SCHEDULE.map((day, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[9px] font-bold tracking-widest opacity-60 relative z-10">{day.label}</span>
                  {activeDay === index && (
                    <motion.div 
                      layoutId="activeTab"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-4">
              {SCHEDULE[activeDay].items.map((item, idx) => (
                <motion.div 
                  key={`${activeDay}-${idx}`}
                  whileHover={{ x: 10, backgroundColor: "rgba(255,255,255,0.05)" }}
                  className="flex flex-col sm:flex-row gap-6 p-6 border border-white/5 transition-all duration-300 surface-frosted group"
                >
            ...
            <div className="relative">
              <div className="sticky top-32 p-12 border border-brand-accent/20 bg-brand-accent/5 overflow-hidden">
                <img src={assetUrl('branding/icon.svg')} className="absolute -top-10 -right-10 text-brand-accent w-64 h-64 rotate-12 opacity-10" alt="Icone" />
                <h3 className="text-3xl font-display font-bold mb-8 relative tracking-tight">Destaques do dia</h3>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  href={whatsappLink}
                  className="mt-12 w-full py-4 px-6 bg-brand-accent text-brand-primary font-bold text-center block tracking-widest hover:shadow-[0_0_20px_rgba(203,255,137,0.3)] transition-all"
                >
          ...
          <div className="flex overflow-hidden">
            ...
            >
              {[...TESTIMONIALS, ...TESTIMONIALS].map((testimonial, i) => (
                <div
                  key={i}
                  className="w-[280px] sm:w-[400px] p-6 sm:p-8 bg-brand-accent/[0.03] border border-white/5 surface-frosted shrink-0"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-1 space-y-6">
              <div className="p-6 border border-white/10 surface-frosted">
      ...
      <footer className="py-20 px-6 border-t border-white/5 bg-brand-primary relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start mb-20">
            <div className="space-y-6">
              <img src={assetUrl('branding/logo-completo.svg')} alt="Edição Pilates" className="h-12" />
