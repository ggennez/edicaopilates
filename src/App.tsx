        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Existe desconto para grupos?", a: "Sim! Nas compras de ingressos para duas pessoas, oferecemos condições especiais. Entre em contato via WhatsApp para saber mais." },
            ].map((faq, i) => (
